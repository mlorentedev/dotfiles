...
if [ -n "${existing}" ]; then
    ...
    gh issue create --title "${ISSUE_TITLE}" --label bitacora-reconcile --body \
...
Filed automatically by \`scripts/bitacora-reconcile.sh\`."
