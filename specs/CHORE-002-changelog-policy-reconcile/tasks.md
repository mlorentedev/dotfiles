...
# Tasks - CHORE-002-changelog-policy-reconcile

> TDD order. One task = one focused commit. Tick as you go. Reorder freely while spec is in `draft` state; freeze once you start `implementing`.

## Setup

- [ ] Branch created from main: `feat/CHORE-002-changelog-policy-reconcile`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/CHORE-002-changelog-policy-reconcile/features.json`):

```json
[
  {
    "id": "CHORE-002-changelog-policy-reconcile-f1",
