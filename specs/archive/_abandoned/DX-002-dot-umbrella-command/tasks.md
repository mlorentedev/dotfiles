...
# Tasks - DX-002-dot-umbrella-command

> TDD order. One task = one focused commit. Tick as you go. Reorder freely while spec is in `draft` state; freeze once you start `implementing`.

## Setup

- [ ] Branch created from main: `feat/DX-002-dot-umbrella-command`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/DX-002-dot-umbrella-command/features.json`):

```json
[
  {
    "id": "DX-002-dot-umbrella-command-f1",
