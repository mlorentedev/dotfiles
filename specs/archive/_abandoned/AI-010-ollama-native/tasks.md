...
# Tasks - AI-010-ollama-native

> TDD order. One task = one focused commit. Tick as you go. Reorder freely while spec is in `draft` state; freeze once you start `implementing`.

## Setup

- [ ] Branch created from main: `feat/AI-010-ollama-native`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/AI-010-ollama-native/features.json`):

```json
[
  {
    "id": "AI-010-ollama-native-f1",
