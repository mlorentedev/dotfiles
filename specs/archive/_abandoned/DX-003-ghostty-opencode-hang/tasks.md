...
# Tasks - DX-003-ghostty-opencode-hang

> TDD order. One task = one focused commit. Tick as you go. Reorder freely while spec is in `draft` state; freeze once you start `implementing`.

## Setup

- [ ] Branch created from main: `feat/DX-003-ghostty-opencode-hang`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/DX-003-ghostty-opencode-hang/features.json`):

```json
[
  {
    "id": "DX-003-ghostty-opencode-hang-f1",
