...
# Tasks - REFACTOR-007-scripts-dir-env-contract

> TDD order. One task = one focused commit. Tick as you go. Reorder freely while spec is in `draft` state; freeze once you start `implementing`.

## Setup

- [ ] Branch created from main: `feat/REFACTOR-007-scripts-dir-env-contract`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/REFACTOR-007-scripts-dir-env-contract/features.json`):

```json
[
  {
    "id": "REFACTOR-007-scripts-dir-env-contract-f1",
