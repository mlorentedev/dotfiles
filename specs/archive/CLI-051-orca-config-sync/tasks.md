---
tags: [spec, tasks, orca, cli, deploy]
created: "2026-08-27"
---
...
- [x] Implement `cli/internal/orca/orca.go` to export keybindings and clean settings.
- [x] Implement `cli/internal/orca/orca.go` with process checking and atomic updates.
