...
# Tasks - BUG-020-pwsh-profile-corruption-heal

> TDD order. One task = one focused commit. Tick as you go. Reorder freely while spec is in `draft` state; freeze once you start `implementing`.

## Setup

- [ ] Branch created from main: `feat/BUG-020-pwsh-profile-corruption-heal`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/BUG-020-pwsh-profile-corruption-heal/features.json`):

```json
[
  {
    "id": "BUG-020-pwsh-profile-corruption-heal-f1",
