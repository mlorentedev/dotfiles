...
# Tasks - AGENTS-001-subagents-as-vault-artifact

> TDD order. One task = one focused commit. Tick as you go. Reorder freely while spec is in `draft` state; freeze once you start `implementing`.

## Setup

- [ ] Branch created from main: `feat/AGENTS-001-subagents-as-vault-artifact`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/AGENTS-001-subagents-as-vault-artifact/features.json`):

```json
[
  {
    "id": "AGENTS-001-subagents-as-vault-artifact-f1",
