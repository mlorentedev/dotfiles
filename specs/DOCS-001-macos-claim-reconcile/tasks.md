...
# Tasks - DOCS-001-macos-claim-reconcile

> TDD order. One task = one focused commit. Tick as you go. Reorder freely while spec is in `draft` state; freeze once you start `implementing`.

## Setup

- [ ] Branch created from main: `feat/DOCS-001-macos-claim-reconcile`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/DOCS-001-macos-claim-reconcile/features.json`):

```json
[
  {
    "id": "DOCS-001-macos-claim-reconcile-f1",
