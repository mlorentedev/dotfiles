...
- [ ] Branch created from main: `feat/CLI-012-dotf-doctor`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/CLI-012-dotf-doctor/features.json`):

```json
[
  {
    "id": "CLI-012-dotf-doctor-f1",
