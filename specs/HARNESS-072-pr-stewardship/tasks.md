...
- [ ] Branch created from main: `feat/HARNESS-072-pr-stewardship`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/HARNESS-072-pr-stewardship/features.json`):

```json
[
  {
    "id": "HARNESS-072-pr-stewardship-f1",
