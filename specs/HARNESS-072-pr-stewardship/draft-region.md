<!-- DRAFT of the vault section for `pattern-change-lifecycle.md`, NOT yet applied.
     Held here instead of half-written into the shared vault tree, because the
     vault working tree is shared by several sessions and an uncommitted draft
     there was nearly lost once. Revised for the two kubelab objections — see
     proposal.md "Risks", AC3 and AC4. -->
