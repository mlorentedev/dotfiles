...
- [ ] Folder moved: `specs/SDD-038-archive-on-merge/` -> `specs/archive/SDD-038-archive-on-merge/`
- [ ] Bitácora board ticket for this spec moved to Done / closed with PR link (ADR-018)
- [ ] Promotions above executed (if any)

> Deliberately unticked. This PR does **not** close #670 — the one-time sweep of the ~21 already-shipped specs is the follow-up, and that PR is what closes the issue. It will therefore have to archive this spec to pass the very gate introduced here, which is the intended first dogfood.
