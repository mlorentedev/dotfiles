...
# Tasks - IDEAS-007-cross-provider-agent-harness

> TDD order. One task = one focused commit. Tick as you go. Reorder freely while spec is in `draft` state; freeze once you start `implementing`.

## Setup

- [ ] Branch created from main: `feat/IDEAS-007-cross-provider-agent-harness`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/IDEAS-007-cross-provider-agent-harness/features.json`):

```json
[
  {
    "id": "IDEAS-007-cross-provider-agent-harness-f1",
