...
# Tasks - REFACTOR-006-setup-phase-decompose

> TDD order. One task = one focused commit. Tick as you go. Reorder freely while spec is in `draft` state; freeze once you start `implementing`.

## Setup

- [ ] Branch created from main: `feat/REFACTOR-006-setup-phase-decompose`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/REFACTOR-006-setup-phase-decompose/features.json`):

```json
[
  {
    "id": "REFACTOR-006-setup-phase-decompose-f1",
