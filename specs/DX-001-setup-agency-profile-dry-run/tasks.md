...
# Tasks - DX-001-setup-agency-profile-dry-run

> TDD order. One task = one focused commit. Tick as you go. Reorder freely while spec is in `draft` state; freeze once you start `implementing`.

## Setup

- [ ] Branch created from main: `feat/DX-001-setup-agency-profile-dry-run`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/DX-001-setup-agency-profile-dry-run/features.json`):

```json
[
  {
    "id": "DX-001-setup-agency-profile-dry-run-f1",
