...
- [ ] Branch created from main: `feat/CLI-011-release-please`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/CLI-011-release-please/features.json`):

```json
[
  {
    "id": "CLI-011-release-please-f1",
