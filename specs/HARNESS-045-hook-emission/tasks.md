...
- [ ] Branch created from main: `feat/HARNESS-045-hook-emission`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/HARNESS-045-hook-emission/features.json`):

```json
[
  {
    "id": "HARNESS-045-hook-emission-f1",
