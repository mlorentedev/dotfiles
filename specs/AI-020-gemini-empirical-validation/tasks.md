...
# Tasks - AI-020-gemini-empirical-validation

> TDD order. One task = one focused commit. Tick as you go. Reorder freely while spec is in `draft` state; freeze once you start `implementing`.

## Setup

- [ ] Branch created from main: `feat/AI-020-gemini-empirical-validation`
...
Minimal `features.json` skeleton (drop into `<repo>/specs/AI-020-gemini-empirical-validation/features.json`):

```json
[
  {
    "id": "AI-020-gemini-empirical-validation-f1",
