...
| [276 - A helper written to "mirror" an existing parser is the defect; the transcription bug is only how you find out](lesson-276-a-helper-written-to-mirror-a-parser-is-the-defect.md) | 2026-09-05 |  |
