...
13 top-level directories. 13 tracked root-level files. 17 skill subdirs under `ai/skills/`.
...
| **Skills port** | `skills-to-opencode.sh` | Mechanical transform: `ai/skills/*/SKILL.md` → `ai/opencode/commands/*.md`. AI-012. |
...
| Skill (Claude) | `ai/skills/<name>/SKILL.md` | Auto-loaded by Claude Code. Deployed to `~/.claude/skills/`. |
| Skill (OpenCode mirror) | `ai/opencode/commands/<name>.md` | Generated by `skills-to-opencode.sh --check` (CI gate). |
